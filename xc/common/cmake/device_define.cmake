...
function(ADD_XC_DEVICE_DEFINE_TYPE)
  ...
  set(USE_PART_PINS ${ADD_XC_DEVICE_DEFINE_TYPE_USE_PART_PINS})
  ...
  if(NOT "${ROI_DIR}" STREQUAL "")
    if (NOT ${USE_PART_PINS})
      ...
      set(ROI_ARGS USE_ROI ${ROI_DIR}/design.json USE_PART_PINS ${ROI_DIR}/partition_pins.txt)
    endif()
...
function(ADD_XC_DEVICE_DEFINE)
  set(options USE_ROI USE_PART_PINS)
  ...
  set(USE_PART_PINS ${ADD_XC_DEVICE_DEFINE_USE_PART_PINS})
  ...
  foreach(INDEX RANGE ${DEVICE_COUNT_N_1})
    ...
    if(${USE_ROI})
        ...
        if(${USE_PART_PINS})
            set(RR_PATCH_EXTRA_ARGS --use_part_pins ${RR_PATCH_EXTRA_ARGS})
        endif()
    endif()
